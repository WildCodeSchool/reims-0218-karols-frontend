...
describe.only("showDatePicker", () => {
  ...
  //should return true if table is selected(ou ||)
  it("should return false if no table is selected", () => {
    ...
    expect(showDatePicker(noTableSelected)).toEqual(false)
  })
  it("should return true if table is selected", () => {
    const tableSelected = {
      prestations: [
        {
          id: 1,
    ...
    expect(showDatePicker(tableSelected)).toEqual(true)
  })
})
