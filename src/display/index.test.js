import { showServices, showDatePicker, showSex, showFemalePrestation, showMalePrestation } from "."
...
describe("showSex", () => {
  it("should return false if no reservation is selected", () => {
...
describe("showFemalePrestations", () => {
  it("should return false if the female gender selected", () => {
