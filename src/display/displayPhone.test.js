...
describe("showPhone", () => {
  it("should return false if no shop selected", () => {
    ...
    expect(showPhone(noSelectedShopState)).toEqual(false)
  })
  it("should return true if a shop is selected", () => {
    ...
    expect(showPhone(selectedShopState)).toEqual(true)
  })
})
