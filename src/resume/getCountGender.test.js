import { getCountGender } from "."

describe("getCountGender", () => {
  it("should return count data when male of female is selected", () => {
    const countGender = {
      prestations: [
        {
          _id: "5b3dec6b2136da7c7d71d540",
          id: 2,
          name: "Coiffure",
          image: "",
          description: "",
    ...
    expect(getCountGender(countGender)).toEqual(expected)
  })
})
