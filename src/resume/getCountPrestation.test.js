import { getCountByPrestation } from "."

describe.only("getCountByPrestation", () => {
  it("should return count with max gender", () => {
    ...
    expect(getCountByPrestation(1, prevState)).toEqual(6)
    expect(getCountByPrestation(2, prevState)).toEqual(5)
  })
})
